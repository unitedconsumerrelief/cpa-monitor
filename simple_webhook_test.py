#!/usr/bin/env python3
"""
Simple webhook test that doesn't require Google Sheets access
"""
...
async def test_webhook():
    ...
    try:
        async with aiohttp.ClientSession() as session:
            ...
            print(f"📄 Data: {json.dumps(SAMPLE_WEBHOOK_DATA, indent=2)}")
...
async def main():
    """Main test function"""
    print("🚀 Starting Simple Webhook Debug Tests")
    print("=" * 50)
    print("⚠️  Make sure your webhook server is running first!")
